...
const R1_HDR=['STATUS','Changed','ASIN','Title','Sell range','ROI low %','ROI high %','SAS','Keepa','Buy link','UK sell link','Buy market','Landed £','Discount applied','Sell £ used','Sell used','Breakeven sell £','Profit £','ROI %','Best case','Review?','GOOD LEAD?','HAPPY ON SHEET?','WHY','SPM','SPM from','Buy price (local)','Basket qty','ROI at BuyBox90 %','Sell low £','Sell high £','Sell FBA now £','Sell FBA 30d £','Sell FBA 90d £','Sell BB 90d £','UK Amazon now £','Phase 2 (ROI>=10%)','OA price-match','All Amazon prices','Dropped in','Referral %','FBA fee £','kg','Fees from','LTD badge','Category','Flags','Last seen','Tracking since','Listed since'];
const R2_HDR=['#','STATUS','Changed','Score','Potential score','Potential via','ASIN','Product','Brand','Buy at £','After discount £','Discount applied','Sell for £','Sell from','Sell confidence','Buy Box 90d £','Buy Box 180d £','FBA 90d £','FBM 90d £','Buy Box high £','Profit £','ROI %','Sells /mo','Demand from','£ per month','Needs % off','Brand discount %','Check OA?','FBA resale proven?','No 3P history?','Limited time deal?','Amazon 90d drop %','Offers','FBA offers','FBM offers','Reviews','Age days','VAT %','VAT from','Review?','GOOD LEAD?','WHY','Keepa','Buy link','SAS','Tracking since','Listed since','Last seen'];
